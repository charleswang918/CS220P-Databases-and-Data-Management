drop database if exists cs220p;

create database if not exists cs220p;
use cs220p;
CREATE TABLE `person` (
...
INSERT INTO `employee` (`card_id`, `supervisor_card_id`,`schedule`, `employee_type`, `salary_hour`) VALUES (15,3, '8am-4pm', 'full time', '25.00');
...
GRANT SELECT ON cs220p.* TO 'tester'@'%';
FLUSH PRIVILEGES;
